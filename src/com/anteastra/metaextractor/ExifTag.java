...
final class ExifTag extends Tag {
	...
	public String getStringRepresetation() {
		...
		if (tagID == MetaDataHandler.EXIF_TAG_ORIENTATION) {
			...
			switch(val){
			case 1:
				result ="The 0th row is at the visual top of the image," +
			...
			case 2:
				...
				break;
			case 3:
				result ="The 0th row is at the visual bottom of the image," +
						" and the 0th column is the visual right-hand side";
				break;
			case 4:
				result ="The 0th row is at the visual bottom of the image," +
				...
				break;
			case 5:
				result ="The 0th row is the visual left-hand side of the image," +
						" and the 0th column is the visual top";
				break;
			case 6:
				result ="The 0th row is the visual right-hand side of the image," +
						" and the 0th column is the visual top";
				break;
			case 7:
				result ="The 0th row is the visual right-hand side of the image," +
